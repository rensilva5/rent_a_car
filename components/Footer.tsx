...
const Footer = () => {
  return (
    <footer className="flex flex-col text-black-100
        ...
        sm:px-16 px-6 py-10">
          <div className="flex flex-col flex justify-start items-start gap-6">
            {/* <Image src="/logo.svg" alt="Logo" width={118} height={18} className="object-contain"/> */}
            <Image src="/logo.png" alt="Logo" width={118} height={18} className="object-contain"/>
            <p className="text-baase text-gray-700">
              {/* Car Hub 2023<br /> */}
              {/* All rights reverve &copy; */}
            </p>
          </div>
          ...
          <div className="flex justify-between
            ...
            border-gray-100 sm:px-16 px-6 py-10">
              <p>@2023 RentACar. All rights reserved</p>
